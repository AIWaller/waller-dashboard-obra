...
<div class="page">
  ...
  <table>
    <thead><tr><th>#</th><th>Concepto</th><th>Unidad</th><th>Cantidad</th><th>P.Unit.</th><th>Importe</th></tr></thead>
    <tbody>${compRows}</tbody>
    <tfoot>
      <tr><td colspan="5">Subtotal Complementarios</td><td>${D.comp_sub}</td></tr>
      <tr><td colspan="5">IVA</td><td>${D.comp_iva}</td></tr>
      <tr class="tr"><td colspan="5">Total</td><td>${D.comp_tot}</td></tr>
    </tfoot>
  </table>
